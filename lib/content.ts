...
export const PLANOS = {
  ...
  subtitulo:
    'Planos pensados para diferentes fases de profissionais e empresas do mercado imobiliário.',
  toggle: {
    profissionais: 'Profissionais PJ',
    empresas: 'Empresas Imobiliárias',
  },
  profissionais: [
    {
      nivel: 'START',
  ...
  empresas: [
    {
      nivel: 'START',
      preco: 'R$ 497/mês',
      resumo: 'Para empresas que estão estruturando a operação',
      whatsappKey: 'planStart',
      itens: [
        'Especialistas no ecossistema imobiliário',
        'Plataforma digital',
    ...
    },
    {
      nivel: 'SMART',
      preco: 'R$ 847/mês',
      resumo: 'Para empresas com operação ativa e crescente',
      destaque: true,
      badge: 'Mais escolhido',
      whatsappKey: 'planSmart',
      itens: [
    ...
    },
    {
      nivel: 'PERFORMANCE',
      preco: 'R$ 1.497/mês',
      resumo: 'Para empresas com alto volume de documentos e demandas',
      whatsappKey: 'planPerformance',
      itens: [
        'Especialistas no ecossistema imobiliário',
        'Plataforma digital',
